...
static struct fimc_is_sensor_cfg config_imx616[] = {
	...
	FIMC_IS_SENSOR_CFG_EX(3264, 2448,  30, 0, 0, CSI_DATA_LANES_4, 2054, CSI_MODE_VC_DT, PD_NONE, EX_NONE,
	...
	FIMC_IS_SENSOR_CFG_EX(3264, 1836,  30, 0, 1, CSI_DATA_LANES_4, 2054, CSI_MODE_VC_DT, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 3264, 1836),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 2 : 2X2BIN_3264x1836_60FPS */
	FIMC_IS_SENSOR_CFG_EX(3264, 1836,  60, 0, 2, CSI_DATA_LANES_4, 2054, CSI_MODE_VC_DT, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 3264, 1836),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 3 : 2X2BIN_3264x1836_120FPS */
	FIMC_IS_SENSOR_CFG_EX(3264, 1836,  120, 0, 3, CSI_DATA_LANES_4, 2218, CSI_MODE_VC_DT, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 3264, 1836),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 4 : 2X2BIN_3264x1504_30FPS */
	FIMC_IS_SENSOR_CFG_EX(3264, 1504,  30, 0, 4, CSI_DATA_LANES_4, 2054, CSI_MODE_VC_DT, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 3264, 1504),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 5 : 2X2BIN_3264x1472_30FPS */
	FIMC_IS_SENSOR_CFG_EX(3264, 1472,  30, 0, 5, CSI_DATA_LANES_4, 2054, CSI_MODE_VC_DT, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 3264, 1472),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 6 : 2X2BIN_2448x2448_30FPS */
	FIMC_IS_SENSOR_CFG_EX(2448, 2448,  30, 0, 6, CSI_DATA_LANES_4, 2054, CSI_MODE_VC_DT, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2448, 2448),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 7 : 2X2BIN_2144x1200_120FPS */
	FIMC_IS_SENSOR_CFG_EX(2144, 1200,  30, 0, 7, CSI_DATA_LANES_4, 2054, CSI_MODE_VC_DT, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2144, 1200),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 8 : 68 deg Crop 2X2BIN_2640x1980_30FPS */
	FIMC_IS_SENSOR_CFG_EX(2640, 1980,  30, 0, 8, CSI_DATA_LANES_4, 2054, CSI_MODE_VC_DT, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2640, 1980),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 9 : 68 deg Crop 2X2BIN_2640x1488_30FPS */
	FIMC_IS_SENSOR_CFG_EX(2640, 1488,  30, 0, 9, CSI_DATA_LANES_4, 2054, CSI_MODE_VC_DT, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2640, 1488),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 10 : 68 deg Crop 2X2BIN_2640x1216_30FPS */
	FIMC_IS_SENSOR_CFG_EX(2640, 1216,  30, 0, 10, CSI_DATA_LANES_4, 2054, CSI_MODE_VC_DT, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2640, 1216),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 11 : 68 deg Crop  2X2BIN_1968x1968_30FPS*/
	FIMC_IS_SENSOR_CFG_EX(1968, 1968,  30, 0, 11, CSI_DATA_LANES_4, 2054, CSI_MODE_VC_DT, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 1968, 1968),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 12 : H2V2_1632x1224_120FPS */
	FIMC_IS_SENSOR_CFG_EX(1632, 1224,  120, 0, 12, CSI_DATA_LANES_4, 2054, CSI_MODE_VC_DT, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 1632, 1224),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 13 : REMOSAIC_6528x4896_24FPS */
	FIMC_IS_SENSOR_CFG_EX(6528, 4896,  24, 0, 13, CSI_DATA_LANES_4, 2218, CSI_MODE_VC_DT, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 6528, 4896),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 14 : 68 deg Crop REMOSAIC_5264x3948_24FPS */
	FIMC_IS_SENSOR_CFG_EX(5264, 3948,  24, 0, 14, CSI_DATA_LANES_4, 2218, CSI_MODE_VC_DT, PD_NONE, EX_NONE,
	...
	FIMC_IS_SENSOR_CFG_EX(3264, 2448,  24, 0, 18, CSI_DATA_LANES_4, 2218, CSI_MODE_VC_DT, PD_NONE, EX_SEAMLESS_TETRA,
		VC_IN(0, HW_FORMAT_RAW10, 3264, 2448),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
		*/
	/* 19 : 2X2BIN_3264x2448_60FPS */
	FIMC_IS_SENSOR_CFG_EX(3264, 2448,  60, 0, 19, CSI_DATA_LANES_4, 2054, CSI_MODE_VC_DT, PD_NONE, EX_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 3264, 2448),   VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0),       VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
		...
		struct exynos_platform_fimc_is_module *pdata)
{
	...
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL,	GPIO_SCENARIO_ON, gpio_reset, SENSOR_RESET_HIGH, PIN_OUTPUT,    1, 2000);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL,	GPIO_SCENARIO_ON, gpio_none, "on_i2c", PIN_I2C, 1, 15000);

	/* Normal off */
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL,	GPIO_SCENARIO_OFF, gpio_none, SENSOR_SET_DELAY,	PIN_NONE,      0, 5000);
	SET_PIN(pdata, SENSOR_SCENARIO_NORMAL,	GPIO_SCENARIO_OFF, gpio_none, "off_i2c", PIN_I2C, 0, 10);
	...
	/* READ_ROM - POWER ON */
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_none, IMX616_IOVDD,      PIN_REGULATOR, 1, 3000);
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_none, "on_i2c", PIN_I2C, 1, 15000);

	/* READ_ROM - POWER OFF */
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, gpio_none, "off_i2c", PIN_I2C, 0, 0);
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, gpio_none, IMX616_IOVDD,      PIN_REGULATOR, 0, 20000);
