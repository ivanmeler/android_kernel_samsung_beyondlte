...
#define S5K3L6_IOVDD     "VDDIO_1.8V_CAM" /* CAM_VDDIO_1P8 : CAM_VLDO3 is used for all camera commonly */
#define S5K3L6_AVDD      "gpio_ldo_en"       /* RCAM1_AVDD_2P8, RCAM1_DVDD_1P05  */
#define S5K3L6_DVDD      "m_vdd_ldo23"       /* RCAM1_DVDD_1P05 */
#endif
	...
	struct exynos_platform_fimc_is_module *pdata)
{
	...
	bool use_avdd_dvdd_share = false;
	...
	use_avdd_dvdd_share = of_property_read_bool(dnode, "use_avdd_dvdd_share");
	...
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, gpio_none, S5K3L6_IOVDD,	PIN_REGULATOR, 0, 20000);
